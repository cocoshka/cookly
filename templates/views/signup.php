  ...
  <div class="auth-box">
    ...
    <form method="post" class="auth-form">
      ...
      <label class="form-item">
        ...
        <div class="input">
          <input class="form-item__input" type="email" name="email" required/>
        </div>
      </label>
      ...
      <label class="form-item">
        ...
        <div class="input">
          <input class="form-item__input" type="password" name="password" required/>
        </div>
      </label>
      ...
      <label class="form-item">
        ...
        <div class="input">
          <input class="form-item__input" type="password" name="repeat_password" required/>
        </div>
      </label>
